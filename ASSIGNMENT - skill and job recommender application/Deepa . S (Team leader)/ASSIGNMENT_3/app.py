...
COS_API_KEY_ID = "TDMA0UIBiuGmrR70vKAOyjMjb6yEQIDdopP3lramM2_I"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/cd817cb9f8e846069d440246c9c241ba::serviceid:ServiceId-c217b979-da6a-4d0b-a5d5-f4f342f1bfe2"
...
@app.route('/')
def index():
    files = get_bucket_contents('abhinav-ibm')
